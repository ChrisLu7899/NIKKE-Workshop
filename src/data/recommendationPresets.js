...
const ALL_RECOMMENDATION_PRESETS = [
  {
    ...
    items: [
      ...
      item("5129", "拉毗：小红帽", "7.5秒；非优越期间可以当减冷却", "4T10，头手甲升级", "3+装弹、优越、攻击（可以4弹也可以3弹1爆伤）", "10/10/10", "战术巨熊", "SR15级"),
      item("5158", "索林：霜雪车票", "7.5秒；一般跟霰弹队用", "无所谓", "无所谓", "10/1/1", "战术/遗迹巨熊", "SR0+级"),
      item("5110", "D：杀手妻子", "7秒；除企业塔用的不多了", "T10头手甲升级", "出啥用啥", "7+/10/7+", "战术/遗迹巨熊", "SR0+级"),
    ],
  },
  {
    id: "flexible-support",
    ...
    items: [
      ...
      item("5007", "普丽瓦蒂", "可以轴外，很好用", "4T10，头手甲升级", "无装弹、攻击、优越（优越和攻击收益差不多）", "10/10/7+", "遗迹巨熊魔方", "珍藏品3阶"),
      item("5126", "芙萝拉", "配皇冠/阿尔卡娜使用", "4T10，头手甲升级", "无所谓", "4+/7+/7+", "战术/遗迹巨熊", "珍藏品3阶"),
      ...
      item("5021", "桑迪", "就业仅限铁优", "4T10，头手甲升级", "无所谓", "7+/7+/1（不开大）", "战术/遗迹巨熊", "珍藏品2阶"),
  ...
  },
  {
    ...
    items: [
      ...
      item("5008", "布兰儿", "黑白兔；主要PVP就业了；需绑定露姬/诺亚尔之一", "无硬性需求", "出啥用啥", "1+/4+/10", "遗迹、战术巨熊", "SR0+级"),
      item("5009", "诺亚尔", "黑白兔；主要PVP就业了", "T10头手甲升级", "出啥用啥", "7+/9/4+", "战术/遗迹巨熊", "SR0+级"),
      item("5100", "蒂亚", "黑白JK；主要爬米西利斯塔，其他玩法用得少", "无硬性需求", "无建议", "7+/1+/1+", "双巨熊/体力神器", "SR0+级"),
      item("5099", "娜嘉", "黑白JK；需要皇冠/蒂亚启动；配皇冠可以不升爆裂", "T10头手甲升级", "出啥用啥", "10/10/10", "战术/遗迹巨熊", "SR0+级"),
      item("5147", "艾玛：战术升级", "特殊双子；前排偶尔会用，普通玩家可以跳过", "可给T10头手甲", "不推荐洗", "4/7+/7+", "战术巨熊", "SR0+级"),
      item("5149", "尤妮华：战术升级", "特殊双子；前排偶尔会用，普通玩家可以跳过", "T10头手甲升级", "优越、攻击", "7+/7+/7+", "战术/遗迹巨熊", "SR0+级"),
    ],
  },
