...
export async function recognize(context) {
  ...
  return recognitionResult(field, context.regions[field], result, ocr?.value ? "constrained-research-level-ocr" : "class-icon-relative-condensed-digits");
}
