      ...
      >
        ...
        >
          ...
          <Button
            variant="contained"
            size="small"
            startIcon={fetchLoading ? <CircularProgress size={18} color="inherit" /> : <CloudSyncOutlinedIcon />}
            onClick={onFetchCharacterData}
            disabled={!allCharacters.length || fetchLoading || downloadLoading || actionsDisabled}
          >
            {t("fetchCharacterData")}
          </Button>

          <Button
            variant="outlined"
            size="small"
            startIcon={downloadLoading ? <CircularProgress size={18} color="inherit" /> : <DownloadOutlinedIcon />}
            onClick={onDownloadCharacterData}
            disabled={!dataReady || fetchLoading || downloadLoading || actionsDisabled}
          >
            {t("downloadCharacterData")}
          </Button>
